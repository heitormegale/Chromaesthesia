...
def Finalsong():
    os.chdir(r"C:\Users\heito\Desktop\UCSB\Spring 2019\15C\Music\FinalSong")
    infiles = []

    for root, dirs, files in os.walk(r"C:\Users\heito\Desktop\UCSB\Spring 2019\15C\Music\FinalSong"):  
...
#sound2 = AudioSegment.from_wav("/path/to/file2.wav")
    ...
    combined_sounds.export(r"C:\Users\heito\Desktop\UCSB\Spring 2019\15C\Music\final.wav", format="wav")
